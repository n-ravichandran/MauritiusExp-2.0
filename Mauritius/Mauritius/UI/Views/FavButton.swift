...
open class FaveButton: UIButton {
    ...
    override open var isSelected: Bool {
        didSet {
            setSelectedWithoutAnimation(isSelected: isSelected)
        }
    }
    
    open var isSelectedWithAnimation: Bool = false {
        didSet {
            self.isSelected = isSelectedWithAnimation
...
extension FaveButton {
    func setSelectedWithoutAnimation(isSelected: Bool) {
        let color  = isSelected ? selectedColor : normalColor
        faveIcon.setFillWithoutAnimation(fillColor: color)
    }
}
