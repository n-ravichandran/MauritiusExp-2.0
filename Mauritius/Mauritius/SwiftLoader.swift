...
public class SwiftLoader: UIView {
    ...
    public class func show(_ animated: Bool) {
        self.show(nil, animated: animated, topMargin: 0)
    }
    
    public class func show(_ animated: Bool, topMargin: Int) {
        self.show(nil, animated: animated, topMargin: topMargin)
    }
    
    public class func show(_ title: String?, animated: Bool) {
        self.show(title, animated: animated, topMargin: 0)
    }
    
    public class func show(_ title: String?, animated: Bool, topMargin: Int) {
    ...
    class SwiftLoadingView : UIView {
        ...
        */
        ...
        private func start() {
            ...
            if let value = speed {
                rotationAnimation.duration = CFTimeInterval(value);
            }
