...
open class MUIAlertController: UIViewController {
    ...
    internal var alertView: UIView = {
        ...
        alertView.backgroundColor = UIColor.muiAlertviewColor
...
// MARK: - Action Methods
extension MUIAlertController {
    open func addAction(action: MUIAlertAction) {
    ...
    @objc func buttonAction(sender: MUIAlertAction) {
